...
//    qDebug() << "1 IVFDTcpClient::SLOT_NewConnect(): " << addr << "@" << portn;
    ...
    bool online = m_tcpClientSocket->waitForConnected(2000);
//    emit SIG_Offline(online);
...
//    qDebug() << "1 IVFDTcpClient::SLOT_TcpSocketSendMsg:";
    if(m_tcpClientSocket != NULL)
    {
//        qDebug() << "1 IVFDTcpClient::SLOT_TcpSocketSendMsg: write socket:" << m_tcpClientSocket->peerAddress() << "@port:" << m_tcpClientSocket->peerPort();
